        ...
        if (nodeData.name === "StandardTriggerWordsLoader") {
            ...
            nodeType.prototype.onNodeCreated = function() {
                ...
                if (!modifyTagsWidget) {
                    ...
                    modifyTagsWidget.options = { serialize: true };
                }
                ...
                const valueDescriptor = Object.getOwnPropertyDescriptor(tagsWidget, 'value');
                const originalSetter = valueDescriptor.set;
                const originalGetter = valueDescriptor.get;
                ...
                Object.defineProperty(tagsWidget, 'value', {
                    ...
                    set(newValue) {
                        ...
                        modifyTagsWidget.value = JSON.stringify(newValue);
                    }
                });
